...
(function () {
  ...
  function loginPage() {
    ...
    fetch('/api/auth/providers')
      ...
      .then(function (p) {
      var social = '';
      // A plain link: the Worker sends the reader to Google (OpenID Connect, form_post)
      // and Google posts a signed ID token back to the callback. No popup, no iframe,
      // nothing for a blocker to refuse, and it works identically on every phone.
